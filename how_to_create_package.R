...
# Trong phần này sẽ hướng dẫn cách tạo và thêm các thành phần để tạo ra 1 package có thể up lên cran
...
## folder: R (tất cả các hàm đều được lưu trong này)
## file: DESCRIPTION và NAMESPACE (2 file này rất quan trọng và sẽ có cách để làm việc với chúng)

# Viết code lưu vào folder R
# Sensitivity
#' @title sensitivity
...
#=============================================================================
# Chỉnh sửa NAMESPACE - Tạo RD file
devtools::document()
roxygen2::roxygenise() # cách khác
## Sau khi sử dụng lệnh này thì sẽ có folder man được tạo ra, folder này chứa các
## hướng dẫn sử dụng các hàm trong package
##
